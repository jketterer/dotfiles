...
local pulse = require("widgets.volume")

local keys = {}

function keys.getKeys(modkey, terminal)
    ...
    -- Menubar
    awful.key({ modkey }, "Escape", function() awful.util.spawn("rofi -show run") end,
              {description = "launch rofi", group = "launcher"}),

    -- Volume keys (TODO: Mic keys?)
